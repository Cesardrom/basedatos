...
select a.nombre, c.nombre from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase;
...
select a.nombre, c.materia from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase; 
...
select a.nombre, a.edad, c.profesor from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase;
...
select a.nombre, a.direccion from Alumnos as a ;
...
│ Miguel │ Calle J   │
└────────┴───────────┘
No hay direccion de la clase
**/

-- Obtener el nombre del alumno y el nombre de la clase junto con el profesor.
select a.nombre, c.nombre, c.profesor from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase; 
...
select a.nombre, c.materia, c.profesor from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase;
...
select a.nombre, a.edad, c.materia from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase;
...
select a.nombre, a.direccion, c.profesor from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase; 
...
select a.nombre, c.materia from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase order by a.nombre; 
...
select count(a.id) as alumnos_matriculados from Alumnos as a, Inscripciones as i INNER JOIN Clases as c on a.id=i.id_alumno and c.id=i.id_clase group by c.id;
